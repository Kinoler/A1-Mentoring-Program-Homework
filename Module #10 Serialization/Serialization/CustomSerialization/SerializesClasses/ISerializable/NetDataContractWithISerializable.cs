...
{
    [Serializable]
    public class NetDataContractWithISerializable : ISerializable, IEnumerable<Product>
    {
        private readonly IEnumerable<Product> _products;

        public NetDataContractWithISerializable()
        {
        }

        public NetDataContractWithISerializable(SerializationInfo info, StreamingContext context)
        {
